...
<div align="center" style="margin: 35px 0;">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=16&height=142&section=header&text=ICCV%202025%20Highlight%20Paper&fontSize=30&fontColor=fff&animation=fadeIn&fontAlignY=38&desc=Honolulu%2C%20Hawaii&descSize=19&descAlignY=62&fontFamily=Playfair+Display" width="100%"/>
</div>
...
|---------|-------|--------|----------|
| [NYUv2](https://cs.nyu.edu/~silberman/datasets/nyu_depth_v2.html) | Semantic Seg. + Depth Est. + Surface Normal Pred. | Indoor Dense Prediction | [Link](https://cs.nyu.edu/~silberman/datasets/nyu_depth_v2.html) |
| [CityScapes](https://www.cityscapes-dataset.com/) | Semantic Seg. + Depth Est. | Outdoor Dense Prediction | [Link](https://www.cityscapes-dataset.com/downloads/) |
...
We thank the authors of the following excellent repositories that facilitated our research: [LibMTL](https://github.com/median-research-group/LibMTL), [CAGrad](https://github.com/Cranial-XIX/CAGrad), [MTAN](https://github.com/lorenmt/mtan), [FAMO](https://github.com/Cranial-XIX/FAMO), and [Nash-MTL](https://github.com/AvivNavon/nash-mtl). We also extend our appreciation to previous studies in the community for their foundational contributions that inspired this work.
