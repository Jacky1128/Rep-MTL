...
|---------|-------|--------|----------|
| [NYUv2](https://cs.nyu.edu/~silberman/datasets/nyu_depth_v2.html) | SemSeg + Depth + Surface Normal | Indoor Dense Prediction | [Link](https://cs.nyu.edu/~silberman/datasets/nyu_depth_v2.html) |
| [CityScapes](https://www.cityscapes-dataset.com/) | SemSeg + Depth | Outdoor Dense Prediction | [Link](https://www.cityscapes-dataset.com/downloads/) |
...
We thank the authors of the following excellent repositories that facilitated our research: [LibMTL](https://github.com/median-research-group/LibMTL), [CAGrad](https://github.com/Cranial-XIX/CAGrad), [MTAN](https://github.com/lorenmt/mtan), [FAMO](https://github.com/Cranial-XIX/FAMO), and [Nash-MTL](https://github.com/AvivNavon/nash-mtl). We also extend our appreciation to many other studies in the broader community for their foundational contributions that inspired this work.
