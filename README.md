...
|---------|-------|--------|----------|
| [NYUv2](https://cs.nyu.edu/~silberman/datasets/nyu_depth_v2.html) | Segmentation + Depth Estimation + Surface Normal | Indoor Dense Prediction | [Link](https://cs.nyu.edu/~silberman/datasets/nyu_depth_v2.html) |
